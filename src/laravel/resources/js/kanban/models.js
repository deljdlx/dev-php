...
export class Ticket {
    /** @param {{ id?: string, title: string, label?: 'blue'|'green'|'orange'|null, category?: 'bug'|'feature'|'docs'|'chore'|null, description?: string|null, createdAt?: number }} param0 */
    constructor({ id, title, label = null, category = null, description = null, createdAt = Date.now() }) {
    ...
    /** @returns {TicketDTO} */
    toJSON() { return { id: this.id, title: this.title, label: this.label, category: this.category, description: this.description, createdAt: this.createdAt }; }
    /** @param {TicketDTO} dto */
